...
const events = [
  { description: 'Random event 1', date: moment('2017-06-06', 'YYYY-MM-DD') },
  { description: 'Random event 2', date: moment('2017-06-15', 'YYYY-MM-DD') },
  { description: 'Random event 3', date: moment('2017-07-01', 'YYYY-MM-DD') }
];
